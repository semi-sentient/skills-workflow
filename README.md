...
| ------------- | ---------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `run-plan`    | `commit`                                 | Per-phase commit messages are authored against the `commit` skill — by each Code agent on the fast path, or by invoking `/commit` directly as the fallback. Without it, the commit step fails (unless `--no-commits` is passed).                                                                                   |
